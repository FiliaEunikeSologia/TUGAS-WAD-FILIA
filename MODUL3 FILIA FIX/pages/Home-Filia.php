...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary " >
        <div class=" d-flex justify-content-left container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item" ><a class="nav-link " href="../pages/Home-Filia" style="color:white;" >Home</a></li>
                <li class="nav-item"><a class="nav-link" href="../pages/ListBuku-Filia" style="color:white;" >MyBookStore</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container text-center" style="padding : 60px 7%">
        <div class="row">
            ...
            <p style="opacity:90%;"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Semoga sehat di TP 4 dan 5!!</p>
<br>
<br>
