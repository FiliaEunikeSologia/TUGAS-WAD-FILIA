...
require ("../config/edit.php");
      $id = $_GET["id"];
      $mobil = querydata("SELECT * FROM tokobuku WHERE id_buku=$id")[0];
      if ( isset($_POST["save"]) ) {
            if ( editing($_POST) > 0 ) {
                  echo "
                  <script> 
                        alert('Data changed');
                        document.location.href = './ListBuku-Filia.php';
                  </script>
                  ";
            } else {
                  echo "
                  <script>
                        ...
                        document.location.href = './List-Filia.php';
                  </script>
                  ";
            } } ; 
?>
...
<div class="col-6 text-left">
     ...
     <div class="mb-3">
        ...
        <a class ="btn btn-primary" href="../pages/ListBuku-Filia.php">Simpan</a>               
    </div>
    </div>
